...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function _displayArticles() {
    _displayArticles = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var dateArray;
  ...
  function _addRemoteDataToArray() {
    _addRemoteDataToArray = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(dateArray) {
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        _context2.next = 3;
                        return fetch(url + apiKey + '&date=' + date).then(function (response) {
